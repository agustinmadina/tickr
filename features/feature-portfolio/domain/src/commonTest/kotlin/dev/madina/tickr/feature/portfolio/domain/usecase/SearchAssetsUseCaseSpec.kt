...
internal class SearchAssetsUseCaseSpec : BehaviorSpec({
...
private fun useCase(scheduler: TestCoroutineScheduler) = SearchAssetsUseCase(
    assetCatalogRepository = object : AssetCatalogRepository {
        override suspend fun tradableAssets(): List<Asset> = Catalogue
    },
    coroutineDispatcher = UnconfinedTestDispatcher(scheduler),
)

private val FailingCatalog = object : AssetCatalogRepository {
